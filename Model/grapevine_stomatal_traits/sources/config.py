...
class ScenariosTraits(Enum):
    baseline: dict = {"g0": 0.01145, 'm0': 5.41, 'psi0': -1.27}
    low_gmax: dict = {"g0": 0.01145, 'm0': 1.85, 'psi0': -1.27}
    high_gmax: dict = {"g0": 0.01145, 'm0': 7.55, 'psi0': -1.27}
    high_gsp50: dict = {"g0": 0.01145, 'm0': 5.41, 'psi0': -0.93}
    low_gsp50: dict = {"g0": 0.01145, 'm0': 5.41, 'psi0': -1.54}
    elite: dict = {"g0": 0.01165, 'm0': 0.9969, 'psi0': -0.85}
    #baseline: dict = {"g0": 0.01145, 'm0': 5.17, 'psi0': -1.27}
    #low_gmax: dict = {"g0": 0.01145, 'm0': 1.76, 'psi0': -1.27}
    #high_gmax: dict = {"g0": 0.01145, 'm0': 7.22, 'psi0': -1.27}
    #high_gsp50: dict = {"g0": 0.01145, 'm0': 5.17, 'psi0': -0.93}
    #low_gsp50: dict = {"g0": 0.01145, 'm0': 5.17, 'psi0': -1.54}
    #elite: dict = {"g0": 0.01165, 'm0': 0.917, 'psi0': -0.85}
